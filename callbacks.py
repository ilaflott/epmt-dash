...
# Create model
    if recentbtn is 'save_model':
        if sel_jobs:
            ...
            refa = make_refs(1, name=model_name_input, jobs=selected_rows)
            refa = pd.DataFrame(
